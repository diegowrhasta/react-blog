        ...
        <p>
          <ul>
            ...
            <li>
              ...
              structures alongside multi-purpose day-to-day code.
              (Microservices, Monoliths, Modular Monoliths).
            </li>
            <li>
            ...
            <li>
              ...
              mentorship perspective but also organization of work and
              enablement of team members.
            </li>
            <li>
              Vast experience with best practices and tendencies when it comes
              to Restful APIs and Web Systems.
            </li>
            <li>
              Excellent experience with streaming architectures specifically
              with Apache Flink, and the ELK Stack.
            </li>
          </ul>
        </p>
      </section>
        ...
        <p>
          <ul>
            <li>
              ...
              variety of projects for clients in different industries but
              focused on high transaction sytems for health, banking and
              financial institutions. (Angular, .NET, React)
            </li>
            <li>
